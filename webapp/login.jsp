            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=150><INPUT id=txtName 
                  style="WIDTH: 130px" name=t.user_code value="suchuner"></TD>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px"><INPUT id=txtPwd style="WIDTH: 130px" 
                  type=password name=t.user_password value="suchuner"></TD>
              ...
              <TR>
                ...
                <TD><INPUT id=btn 
                  ...
                  <button   onclick="register()" type="button"  >点击注册</button>
