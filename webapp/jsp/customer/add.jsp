...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/customer_addCustomer"
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="t.cust_name">
								</td>
								<td>客户级别 ：</td>
								<td>
							...
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="t.cust_phone">
								</td>
								<td>移动电话 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="t.cust_mobile">
								</td>
							</TR>
							<tr>
							<td>客户资质 ：</td>
