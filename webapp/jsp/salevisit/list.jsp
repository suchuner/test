...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/saleVisit_findAll"
		method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>拜访时间：从</TD>
													<TD>
													<input type="text" id="visit_time" name="t.visit_time" readonly="readonly" value="<s:date name="t.visit_time" format="yyyy-MM-dd"/>"/>
													</TD>
													<TD>到</TD>
													<TD>
													<input type="text" id="visit_end_time" name="t.visit_end_time" readonly="readonly" value="<s:date name="t.visit_end_time" format="yyyy-MM-dd"/>"/>
													</TD>
